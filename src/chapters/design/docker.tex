...
\begin{codeBlock}
  ...
  loki:
    ...
    networks:
      - rschat-net
	\end{minted}
	\caption{Servicio de Loki para el registro de logs (fichero \monoFont{docker-compose.yaml})}
\end{codeBlock}
...
\begin{codeBlock}
  ...
  promtail:
    ...
    networks:
      - rschat-net
	\end{minted}
	\caption{Servicio de Promtail para la recolección de logs (fichero \monoFont{docker-compose.yaml})}
\end{codeBlock}
...
\begin{codeBlock}
	...
	\monoFont{tag} (fichero \monoFont{promtail.yaml})}
\end{codeBlock}
