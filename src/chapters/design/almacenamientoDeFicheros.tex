...
en los buckets se denominan \boldFont{objetos}, identificados por una clave única.
...
Para poder interactuar con el bucket de S3 desde la aplicación, se ha creado una clase denominada \monoFont{S3} que
