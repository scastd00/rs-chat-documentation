...
\begin{enumerate}
	...
	proyecto software.
	\item \boldFont{Solución}: se describe todo lo relativo a la aplicación web y cómo se ha desarrollado cada
	...
	\item \boldFont{Conclusiones}: se incluyen las conclusiones obtenidas tras el desarrollo del proyecto.
\end{enumerate}
